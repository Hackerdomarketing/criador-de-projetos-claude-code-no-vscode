...
# Versão: Claude Code no VS Code
# ============================================

echo ""
echo "═══════════════════════════════════════"
echo "  Instalando o Criador de Projetos..."
echo "  (Versão: Claude Code no VS Code)"
echo "═══════════════════════════════════════"
echo ""

PASTA_BASE="$HOME/Documents/VSCODE"
...
# Substituir ~/Documents/VSCODE/ pelo caminho real do usuário nos arquivos copiados
sed -i '' "s|~/Documents/VSCODE/|$PASTA_BASE/|g" "$PASTA_BASE/CRIADOR-DE-PROJETOS/AGENTE.md" 2>/dev/null || true
sed -i '' "s|~/Documents/VSCODE/|$PASTA_BASE/|g" "$PASTA_BASE/CRIADOR-DE-PROJETOS/REGRA-ATIVACAO.md" 2>/dev/null || true
...
echo ""
echo "  Próximo passo:"
echo "  Abra o VS Code com Claude Code e diga:"
